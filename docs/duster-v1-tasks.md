...
- [x] Duster deployability — portable artifacts (`PORT` / `REDIS_URL`, hardened image, Kustomize base+overlay, `DEPLOY.md`) — PR #55
- [x] Deploy Duster to the cluster — first-class service + `duster.yaml` CI + GitOps overlay — PR #56

...
- 2026-08-29 — authos: `POST /oauth/revoke` (RFC 7009) — client-authenticated, always 200, refresh-token revoke cascades to that grant's access tokens, other-client/unknown tokens are a no-op

...
- 2026-08-29 — docs: design decision #31 — frontend SDK is a framework-agnostic `@authos/duster-core` + thin React/Vue/Angular adapters (core also = the vanilla-JS build); in-monorepo `packages/` npm workspace, public npm, no polling; archived shipped decisions #4 + #15 to `archive/duster-v1-design-archive.md` to stay under the size cap
